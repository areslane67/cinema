...
<body>
    <header>
        <ul>
            <li><a class="focus" href="./location.php">Location</a></li>
    ...
    <main>
        ...
        <section class="choix">
            <h2>Faite votre choix par theme :</h2>
            <div>
                <ul>
                    <li><img src="./assets/filmej.jpg" alt="img"><p>FREDDY</p><a href="">plus de details</a></li>
                    <li><img src="./assets/filmef.jpg" alt="img"><p>SCREAM</p><a href="">plus de details</a></li>
                    <li><img src="./assets/filmee.jpeg" alt="img"><p>MEGAN</p><a href="">plus de details</a></li>
                </ul>
            </div>
        </section>
    </main>
